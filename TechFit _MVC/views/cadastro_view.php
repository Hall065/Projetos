...
<body class="bg-gray-900 text-white flex items-center justify-center min-h-screen">
  <div class="w-full max-w-md bg-gray-800 rounded-xl shadow-2xl p-8">
    ...
    <h2 class="text-xl font-semibold mb-4 text-center">Crie sua conta</h2>
    ...
    <form method="POST" action="controllers/AuthController.php?action=register">
      <div class="mb-4">
        <label class="block mb-2 text-gray-400">Nome Completo</label>
        <input type="text" name="nome" class="w-full p-3 bg-gray-700 rounded-lg text-white" placeholder="Seu nome" required>
      </div>
      <div class="mb-4">
      ...
      <div class="mb-4">
        <label class="block mb-2 text-gray-400">Telefone</label>
        <input type="tel" name="telefone" class="w-full p-3 bg-gray-700 rounded-lg text-white" placeholder="(99) 99999-9999" required>
      </div>
      <div class="mb-6">
        <label class="block mb-2 text-gray-400">Senha</label>
        <input type="password" name="senha" class="w-full p-3 bg-gray-700 rounded-lg text-white" placeholder="Crie uma senha forte" required>
      </div>
    ...
    <p class="text-center text-gray-400 mt-6">
      Já tem uma conta? <a href="login.php" class="text-red-500 hover:text-red-400 font-bold">Faça login</a>
    </p>
  </div>
